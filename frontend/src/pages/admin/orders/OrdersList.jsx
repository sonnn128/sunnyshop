...
const OrdersList = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-2">
        <div className="flex flex-wrap gap-2">
          <Button 
            ...
            iconName="ArrowLeft"
            iconPosition="left"
            onClick={() => navigate('/admin/orders/dashboard')}
          >
            Về Dashboard
          </Button>
          <Button
      ...
      {/* Filters */}
      <div className="bg-card/60 backdrop-blur-md border border-border/50 rounded-[2rem] p-8 shadow-elegant space-y-4 relative z-10 overflow-visible">
