    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row justify-between mb-6">
        ...
        <div className="flex space-x-2">
          ...
          <Button
            onClick={() => navigate('/admin/orders/export')}
            className="flex items-center gap-2"
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <Button 
                  ...
                  onClick={() => navigate(`/admin?tab=orders&status=${item.status}`)}
                >
                  Xem chi tiết
          ...
          <div className="p-6">
            <div className="flex flex-col space-y-3">
              ...
              <Button 
                variant="outline" 
                className="justify-start flex items-center gap-2" 
                onClick={() => navigate('/admin?tab=orders&status=pending')}
              >
              ...
              <Button 
                variant="outline" 
                className="justify-start flex items-center gap-2" 
                onClick={() => navigate('/admin?tab=orders&status=processing')}
              >
              ...
              <Button 
                variant="outline" 
                className="justify-start flex items-center gap-2" 
                onClick={() => navigate('/admin?tab=orders&status=shipping')}
              >
