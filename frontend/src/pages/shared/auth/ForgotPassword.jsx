        ...
        <div className="w-full max-w-[420px] mx-auto">
          ...
          <Form onFinish={handleFinish} layout="vertical" className="space-y-8" requiredMark={false}>
            ...
            <div className="mt-10 flex flex-col items-center space-y-4">
              ...
              <Link to="/reset-password" className="inline-block relative text-sm font-bold uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors group">
