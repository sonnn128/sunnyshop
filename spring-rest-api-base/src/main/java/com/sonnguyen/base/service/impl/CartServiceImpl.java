...
import com.sonnguyen.base.model.CartItem;
...
import com.sonnguyen.base.repository.CartItemRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public ApiResponse getCart(User user) {
        ...
        for (CartItem item : items) {
            ...
            BigDecimal price = item.getPriceAtAdd() != null
                    ? item.getPriceAtAdd()
        ...
        return ApiResponse.builder()
                ...
                .data(new CartDto(items, count, total))
                .build();
    }
    ...
    public ApiResponse addItem(User user, Long productId, Long variantId, int quantity) {
        ...
        CartItem existing = cartItemRepository
                .findByUserAndProductIdAndVariantId(user, productId, variantId)
                .orElse(null);
    ...
    public ApiResponse clearCart(User user) {
        ...
        return ApiResponse.builder()
                ...
                .data(new CartDto(List.of(), 0, BigDecimal.ZERO))
                .build();
    }
