  ...
  const handleLogin = (values) => {
    ...
    API.post('/auth/login', { username, password })
      .then(res => {
        ...
        const redirectPath = isAdminUser ? '/admin' : '/user-dashboard';
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-8 sm:px-12 xl:px-24">
        <div className="w-full max-w-[420px] mx-auto">
          ...
          >
            ...
            <Form.Item 
              name="username" 
              label={<span className="text-sm uppercase font-bold tracking-[0.2em] text-slate-400">Tên đăng nhập / Email</span>}
              rules={[
            ...
            <Form.Item 
              name="password" 
              label={<span className="text-sm uppercase font-bold tracking-[0.2em] text-slate-400">Mật khẩu</span>}
              rules={[
            ...
            >
              <Input.Password 
                ...
                className="w-full bg-transparent border-t-0 border-x-0 border-b border-slate-200 py-3 px-2 text-base font-bold tracking-widest text-slate-900 placeholder-slate-300 focus:outline-none focus:border-slate-900 focus:shadow-none hover:border-slate-400 transition-colors rounded-none [&>input]:bg-transparent"
              />
            </Form.Item>
            ...
            <div className="flex items-center justify-between mt-2 mb-8">
              <Form.Item name="remember" valuePropName="checked" noStyle>
                <label className="flex items-center space-x-3 cursor-pointer group">
                  ...
                  />
                  <span className="text-sm font-bold uppercase tracking-[0.1em] text-slate-500 group-hover:text-slate-900 transition-colors">GHI NHỚ ĐĂNG NHẬP</span>
                </label>
              </Form.Item>
              <Link to="/forgot-password" className="text-sm font-bold uppercase tracking-[0.1em] text-slate-400 hover:text-slate-900 transition-colors">QUÊN MẬT KHẨU?</Link>
            </div>

            <div className="pt-2">
              <button type="submit" className="w-full bg-slate-900 text-white py-4 text-sm font-bold uppercase tracking-[0.2em] hover:bg-slate-800 transition-colors flex justify-center items-center">
                ĐĂNG NHẬP
              </button>
            </div>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-sm font-bold tracking-widest uppercase text-slate-400">
                    Chưa có tài khoản?
                  </span>
                </div>
              </div>
              ...
              <div className="mt-8 flex justify-center">
                <Link to="/register" className="inline-block relative text-sm font-bold uppercase tracking-widest text-slate-900 hover:text-slate-500 transition-colors group">
                  TẠO TÀI KHOẢN MỚI
