...
public class AddressRequest {
    ...
    public String getFullNameSnake() { return fullNameSnake; }
    public void setFullNameSnake(String fullNameSnake) { this.fullNameSnake = fullNameSnake; }
    public String getFullName() { return fullName; }
    public void setFullName(String fullName) { this.fullName = fullName; }
    public String getAddressLine1Snake() { return addressLine1Snake; }
    public void setAddressLine1Snake(String addressLine1Snake) { this.addressLine1Snake = addressLine1Snake; }
    public String getAddressLine1() { return addressLine1; }
    public void setAddressLine1(String addressLine1) { this.addressLine1 = addressLine1; }
    public String getAddressLine2Snake() { return addressLine2Snake; }
    public void setAddressLine2Snake(String addressLine2Snake) { this.addressLine2Snake = addressLine2Snake; }
    public String getAddressLine2() { return addressLine2; }
    public void setAddressLine2(String addressLine2) { this.addressLine2 = addressLine2; }
    public Boolean getIsDefaultSnake() { return isDefaultSnake; }
    public void setIsDefaultSnake(Boolean isDefaultSnake) { this.isDefaultSnake = isDefaultSnake; }
    public Boolean getIsDefault() { return isDefault; }
    public void setIsDefault(Boolean isDefault) { this.isDefault = isDefault; }
    public Boolean getIsDefaultFlag() { return isDefaultFlag; }
    public void setIsDefaultFlag(Boolean isDefaultFlag) { this.isDefaultFlag = isDefaultFlag; }
