...
import com.sonnguyen.trendwearshop.service.ExcelService;
import com.sonnguyen.trendwearshop.utils.ExcelHelper;
        ...
        try {
            ...
            for (Product product : products) {
                ...
                if (product.getCategory() != null && product.getCategory().getName() != null) {
                    ...
                    com.sonnguyen.trendwearshop.model.Category category = categoryRepository.findByName(categoryName)
                            .orElseGet(() -> {
                                com.sonnguyen.trendwearshop.model.Category newCategory = new com.sonnguyen.trendwearshop.model.Category();
