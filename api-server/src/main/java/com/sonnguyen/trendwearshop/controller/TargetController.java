...
import com.sonnguyen.trendwearshop.payload.TargetRequest;
import com.sonnguyen.trendwearshop.payload.TargetResponse;
import com.sonnguyen.trendwearshop.service.TargetService;
...
public class TargetController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<com.sonnguyen.trendwearshop.payload.response.ApiResponse<?>> deleteTarget(@PathVariable Long id) {
