...
public class Address {
    ...
    public Address(Long id, String userId, String label, String fullName, String phone, String addressLine1, String addressLine2, String ward, String district, String city, String postalCode, String country, boolean isDefault, boolean isBillingDefault, String provinceCode, String districtCode, String wardCode, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.userId = userId;
        this.label = label;
    ...
    public boolean isBillingDefault() { return isBillingDefault; }
    public void setBillingDefault(boolean isBillingDefault) { this.isBillingDefault = isBillingDefault; }
    ...
    public static class AddressBuilder {
        ...
        public AddressBuilder userId(String userId) { this.userId = userId; return this; }
        ...
        public AddressBuilder isBillingDefault(boolean isBillingDefault) { this.isBillingDefault = isBillingDefault; return this; }
        public AddressBuilder provinceCode(String provinceCode) { this.provinceCode = provinceCode; return this; }
        public AddressBuilder districtCode(String districtCode) { this.districtCode = districtCode; return this; }
        public AddressBuilder wardCode(String wardCode) { this.wardCode = wardCode; return this; }

        public Address build() {
            return new Address(id, userId, label, fullName, phone, addressLine1, addressLine2, ward, district, city, postalCode, country, isDefault, isBillingDefault, provinceCode, districtCode, wardCode, null, null);
        }
    }
}