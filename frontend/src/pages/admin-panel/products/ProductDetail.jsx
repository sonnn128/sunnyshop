    ...
    return (
      <div className="bg-card/60 backdrop-blur-md border border-border/50 rounded-[2rem] p-8 shadow-elegant">
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate('/admin-panel?tab=products')}>Quay lai</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-card/60 backdrop-blur-md border border-border/50 rounded-[2rem] p-8 shadow-elegant">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <Button variant="outline" size="sm" onClick={() => navigate('/admin-panel?tab=products')}>
            <ArrowLeft size={16} />
            Quay lai
          </Button>
          <div>
        ...
        <Link to={`/admin-panel/products/${product._id}`}>
          <Button>
            <Pencil size={16} />
            Chinh sua
          </Button>
