...
import com.sonnguyen.trendwearshop.payload.BrandRequest;
import com.sonnguyen.trendwearshop.payload.BrandResponse;
import com.sonnguyen.trendwearshop.service.BrandService;
...
public class BrandController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<com.sonnguyen.trendwearshop.payload.response.ApiResponse<?>> deleteBrand(@PathVariable Long id) {
