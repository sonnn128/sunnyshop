...
import com.sonnguyen.base.repository.BrandRepository;
import com.sonnguyen.base.utils.SlugUtils;
...
public class BrandService {
    ...
    public Brand update(Long id, Brand updates) {
        ...
        if (updates.getLogoUrl() != null) brand.setLogoUrl(updates.getLogoUrl());
        if (updates.getDescription() != null) brand.setDescription(updates.getDescription());
        if (updates.getWebsite() != null) brand.setWebsite(updates.getWebsite());
    ...
    public void remove(Long id) {
        ...
        // if (count > 0) throw new RuntimeException("Cannot delete brand. It is used by products.");
