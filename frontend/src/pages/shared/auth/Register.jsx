      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-8 sm:px-12 xl:px-24">
        <div className="w-full max-w-[420px] mx-auto">
          ...
          >
            ...
            <Form.Item 
              name="email" 
              label={<span className="text-sm uppercase font-bold tracking-[0.2em] text-slate-400">Email</span>}
              rules={[
            ...
            <Form.Item 
              ...
              className="mb-6"
              extra={<p className="text-sm uppercase tracking-widest text-slate-400 mt-2">* Tối thiểu 8 ký tự, bao gồm chữ và số</p>}
            >
              <Input.Password 
            ...
            <Form.Item 
              ...
              label={<span className="text-sm uppercase font-bold tracking-[0.2em] text-slate-400">Xác nhận mật khẩu</span>}
              rules={[
            ...
            <div className="pt-2">
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-slate-900 text-white py-4 text-sm font-bold uppercase tracking-[0.2em] hover:bg-slate-800 transition-colors flex justify-center items-center disabled:opacity-50"
              >
            ...
            <div className="mt-8">
              ...
              <div className="mt-8 flex justify-center">
                <Link to="/login" className="inline-block relative text-sm font-bold uppercase tracking-widest text-slate-900 hover:text-slate-500 transition-colors group">
                  ĐĂNG NHẬP NGAY
