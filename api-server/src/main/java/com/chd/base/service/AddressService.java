...
import com.chd.base.repository.AddressRepository;
...
public class AddressService {
	...
	public Address create(String userId, AddressRequest req) {
		...
		Address address = Address.builder().userId(userId)
				.label(req.getLabel() != null ? req.getLabel() : "Địa chỉ mới").fullName(req.getResolvedFullName())
				.phone(req.getPhone()).addressLine1(req.getResolvedAddress1())
				.addressLine2(req.getAddressLine2() != null ? req.getAddressLine2() : req.getAddressLine2Snake())
				.ward(req.getWard()).district(req.getResolvedDistrict()).city(req.getCity())
				.country(req.getCountry() != null ? req.getCountry() : "Vietnam").isDefault(isDefault)
	...
	public Address update(Long id, String userId, AddressRequest req) {
		...
		if (req.getResolvedFullName() != null)
			address.setFullName(req.getResolvedFullName());
		if (req.getPhone() != null)
			address.setPhone(req.getPhone());
		if (req.getResolvedAddress1() != null)
			address.setAddressLine1(req.getResolvedAddress1());
		if (req.getResolvedDistrict() != null)
			address.setDistrict(req.getResolvedDistrict());
