...
import com.sonnguyen.trendwearshop.utils.SecurityUtils;
...
public class ReviewController {
    ...
    @PostMapping
    public ResponseEntity<Review> addReview(@RequestBody com.sonnguyen.trendwearshop.payload.request.ReviewRequest request) {
