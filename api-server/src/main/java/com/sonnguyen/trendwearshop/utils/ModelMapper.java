...
public class ModelMapper {
    ...
    public static CartDetailResponse toCartDetailResponse(CartDetail cartDetail) {
        ...
        response.setSize(cartDetail.getSize());
        response.setColor(cartDetail.getColor());
    ...
    // Address mappings
    public static Address toAddress(com.sonnguyen.trendwearshop.payload.request.AddressRequest request) {
