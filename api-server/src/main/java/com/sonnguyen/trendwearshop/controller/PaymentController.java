...
import com.sonnguyen.trendwearshop.config.VNPayConfig;
import com.sonnguyen.trendwearshop.service.OrderService;
...
public class PaymentController {
    ...
    private final com.sonnguyen.trendwearshop.service.CartService cartService;
    private final com.sonnguyen.trendwearshop.repository.OrderRepository orderRepository;
    ...
    public void paymentReturn(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if ("00".equals(vnp_ResponseCode)) {
            try {
                ...
                com.sonnguyen.trendwearshop.model.Order order = orderRepository.findById(orderId).orElse(null);
