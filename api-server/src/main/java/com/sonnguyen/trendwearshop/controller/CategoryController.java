...
import com.sonnguyen.trendwearshop.payload.CategoryRequest;
import com.sonnguyen.trendwearshop.payload.CategoryResponse;
import com.sonnguyen.trendwearshop.service.CategoryService;
...
public class CategoryController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<com.sonnguyen.trendwearshop.payload.response.ApiResponse> deleteCategory(@PathVariable Long id) {
